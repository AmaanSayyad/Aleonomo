...
export interface WalletState {
  ...
  network: 'BNB' | 'SOL' | 'SUI' | 'XLM' | 'XTZ' | 'NEAR' | 'ALEO' | null;
  preferredNetwork: 'BNB' | 'SOL' | 'SUI' | 'XLM' | 'XTZ' | 'NEAR' | 'ALEO' | null;
  ...
  setNetwork: (network: 'BNB' | 'SOL' | 'SUI' | 'XLM' | 'XTZ' | 'NEAR' | 'ALEO' | null) => void;
  setPreferredNetwork: (network: 'BNB' | 'SOL' | 'SUI' | 'XLM' | 'XTZ' | 'NEAR' | 'ALEO' | null) => void;
...
export const createWalletSlice: StateCreator<WalletState> = (set, get) => ({
  ...
  isConnecting: false,
  network: null,
  preferredNetwork: typeof window !== 'undefined' ? (localStorage.getItem('solnomo_preferred_network') as 'BNB' | 'SOL' | 'SUI' | 'XLM' | 'XTZ' | 'NEAR' | 'ALEO' | null) || 'ALEO' : 'ALEO',
   ...
   */
  setPreferredNetwork: (network: 'BNB' | 'SOL' | 'SUI' | 'XLM' | 'XTZ' | 'NEAR' | 'ALEO' | null) => {
